...
document.addEventListener('DOMContentLoaded', function() {
    ...
    dropText.innerHTML = `
        ...
        <p class="mb-2">Kéo thả ảnh mới vào đây hoặc click để chọn</p>
        ...
        reader.onload = function(e) {
            ...
            previewDiv.innerHTML = `
                ...
                <button type="button" 
                        ...
                        onclick="removePreviewEdit(this, ${index})"
                        title="Xóa ảnh">
    ...
    const removeCheckboxes = document.querySelectorAll('input[name="removeImages"]');
...
function removePreviewEdit(button, index) {
    ...
    previews.forEach((preview, newIndex) => {
        ...
        if (badge) {
            badge.textContent = `Mới ${newIndex + 1}`;
        }
        
        const removeBtn = preview.querySelector('button');
        if (removeBtn) {
            removeBtn.setAttribute('onclick', `removePreviewEdit(this, ${newIndex})`);
        }
    });
